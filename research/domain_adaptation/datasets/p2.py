"""Provides data for the p2 datasets.
"""
...
_FILE_PATTERN = 'p2_%s.tfrecord'

_SPLITS_TO_SIZES = {'train': 4766, 'valid': 4741, 'test': 1754}
...
def get_split(split_name, dataset_dir='/data2/tmp/imalkin/',
    ...
    """Get a `Dataset` struct for reading the P2 dataset.
    Args:
